...
# create 2 circles with a radius of 10 with the same center point
    ...
    Model.SketchManager.CreateCircleByRadius(0, 0, 0, 15)
...
# extrude the the bottom circle 10mm in the Z direction
    ...
    Model.FeatureManager.FeatureExtrusion2(True, False, False, 0, 0, 50, 0, False, False, False, False, 0, 0, False, False, False, False, True, True, True, 0, 0, False)
